...
class _MapChoicePointState extends State<MapChoicePoint>
  ...
  //自定义marker点图标图片路径 attention!!need you add some icon photo
  Uri _imgUri = Uri.parse('images/locationphoto.jpeg');
    ...
    if (await Permission.location.request().isGranted)
      ...
      showDialog(
          ...
          builder: (context) {
            return AlertDialog(
              title: Text("注意"),
              content: Text("如需获取当前地理位置请打开定位权限！"),
              actions: <Widget>[
                TextButton(
                  child: Text("cancel"),
                  onPressed: () {
            ...
            if (lon == slon && lat == slat) {
              ...
              _markerSelect = await _amapController?.addMarker(MarkerOption(
                  ...
                  iconProvider: NetworkImage(
                      'http://bpic.588ku.com/element_origin_min_pic/18/06/10/06049e74f465555f6b35c026ed1e83bc.jpg'),
                  anchorV: 0.7,
                  anchorU: 0.5));
            }
          },
